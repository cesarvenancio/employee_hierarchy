...
class EmployeeServiceTest(@Autowired val employeeService: EmployeeService) {
    ...
    @Test
    fun getEmployeeTest() {
        val employee: Employee? = employeeService.getEmployeeByName("TEST_EMPLOYEE");
    ...
    fun getSupervisorsTest() {
        val employeeSupervisors: EmployeeSupervisorsResponse? = employeeService.getEmployeeSupervisorsByEmployeeName("TEST_EMPLOYEE");
    ...
    fun saveEmployeeHierarchyTest() {
        var employee: Employee? = employeeService.getEmployeeByName("TEST_EMPLOYEE");
